...
/*!
 * @file InsDataPubSubTypes.h
 * This header file contains the declaration of the serialization functions.
 *
 * This file was generated by the tool fastcdrgen.
 */

#ifndef _FAST_DDS_GENERATED_VEHICLE_MSGS_MSG_INSDATA_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_VEHICLE_MSGS_MSG_INSDATA_PUBSUBTYPES_H_
...
#error \
    Generated InsData is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
...
namespace vehicle_msgs
{
    namespace msg
    {
        class InsDataPubSubType : public eprosima::fastdds::dds::TopicDataType
        {
        public:
            typedef InsData type;

            eProsima_user_DllExport InsDataPubSubType();
            eProsima_user_DllExport virtual ~InsDataPubSubType() override;
...
#endif // _FAST_DDS_GENERATED_VEHICLE_MSGS_MSG_INSDATA_PUBSUBTYPES_H_
